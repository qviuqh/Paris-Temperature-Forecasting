...
def plot_phik_matrix(data, categorical_columns, figsize=(20,20), mask_upper=True, tight_layout=True, linewidth=0.1, fontsize=10, cmap='Blues'):
    ...
    plt.figure(figsize=figsize, tight_layout=tight_layout)
    sns.heatmap(phik_matrix, annot=False, vmin=-1, vmax=1, mask=mask_array, linewidth=linewidth, cmap=cmap)
...
class correlation_matrix:
    ...
    def plot_correlation_matrix(self):
        ...
        sns.heatmap(self.corr_data, annot=False, vmin=-1, vmax=1, mask=mask_array, linewidth=self.linewidth, cmap=self.cmap)
